...
creator = '乂𝕺𝖕𝖆𝕱𝖆𝖓𝖘𝖘-𝕭𝖔𝖙乂' // Nama 
port = 8080 //port host
LimitApikey = 20 // Limit Apikey default

//___________ ┏  Database Mongodb Setting  ┓ ___________\\

keymongodb = process.env.mongodb+srv://giriraya:Z1QCUzY8aqW8nebb@webapi.5ccbbxt.mongodb.net/?retryWrites=true&w=majority
...
servicesmtp = 'rajabarbar2080@gmail.com'//Ada gmail ada sendinblue ikut masing2 limit gmail 500 limit sendinblue 300 free. List service smtp : https://nodemailer.com/smtp/well-known/
...
domain = 'opafanss.xyz'// domain website tanpa http or https
